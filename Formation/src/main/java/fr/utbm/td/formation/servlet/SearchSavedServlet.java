 ...
 * @author ag
 */
@WebServlet(name = "searchsaved", urlPatterns = {"/searchsaved"})
public class SearchSavedServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<SearchCourses> sc = scService.getSearches();
        
        request.setAttribute("searches", sc);
        
        RequestDispatcher rd = request.getRequestDispatcher("WEB-INF/searchsaved.jsp");
